...
M=16; 
K=input('Ingrese el numero de simbolos que desea modular: '); %Numero simbolos
b= 4 %numero de bits para cada simbolo
...
SeTx = pskmod(datosIn,M,pi/M); %Bits modulados con 16psk 
